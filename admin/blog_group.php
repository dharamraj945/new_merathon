            ...
            <div class="card-body">
                <form action="./bloge_backend.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="section_title" required="" type="text" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="form-group">
                        ...
                        <input name="section_desc" required="" type="text" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="button">
                        ...
                        <button name="add_blog_group" class="btn btn-primary" type="submit">Submit</button>
                    </div>
